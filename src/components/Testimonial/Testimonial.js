                ...
                <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
                    <div class="mx-auto max-w-xl text-center">
                        ...
                        <p class="text-gring-offset-warm-gray-500 mx-auto mt-4 max-w-lg">
                            Our main concern is to deliver the right project so that it converts money for the clients. We are polite & protect privacy about the projects.
                        </p>
                    </div>
                    ...
                    >
                        ...
                        <div>
                            ...
                            >
                                ...
                                <p class="mt-4 text-sm text-gray-500">
                                    They provide responsive websites amd the UI & UX is 100% matched with the design.
                                </p>
                        ...
                        <div>
                            ...
                            <blockquote
                                class="-mt-6 flex flex-col justify-between rounded-lg p-12 text-center shadow-xl"
                            >
                                <p class="text-lg font-bold text-gray-700">Andreu John</p>
                                <p class="mt-1 text-xs font-medium text-gray-500">
                                    Digital Marketing Manager
                                </p>
                                <p class="mt-4 text-sm text-gray-500">
                                    They have ranked our business on the Google. We are getting lots of sales.
                                </p>
